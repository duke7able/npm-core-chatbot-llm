...
[![NPM Version](https://img.shields.io/npm/v/react-openai-chatbot)](https://www.npmjs.com/package/react-openai-chatbot)
[![License](https://img.shields.io/npm/l/react-openai-chatbot)](https://opensource.org/licenses/MIT)
[![Build Status](https://img.shields.io/badge/Status-Success-brightgreen)](https://github.com/duke7able/react-openai-chatbot)
[![GitHub Stars](https://img.shields.io/github/stars/duke7able/react-openai-chatbot?style=social)](https://github.com/duke7able/react-openai-chatbot)
[![React Version](https://img.shields.io/npm/dependency-version/react-openai-chatbot/peer/react)](https://www.npmjs.com/package/react)[![Node Version](https://img.shields.io/static/v1?label=Node&message=v18&color=green)](https://nodejs.org/)
...
<p align="center">
  <img src="/public/newchatbot.gif" alt="React OpenAI Chatbot" width="35%" height="50%" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
_Note:_ This might take longer it would be optimised in upcoming builds
...
To generate a OpenAI API key, go to OpenAI Platform Settings: [Open AI Platform](https://platform.openai.com/settings/organization/api-keys).
...
| `apiKey`                       | string  | `""`                                                                                                                                 | _Yes_    | Your OpenAI API key.                                                                                                                                                                                                                                                                                                                        |
...
| `model`                        | string  | `gpt-4o-mini`                                                                                                                        | _No_     | OpenAI model to use (e.g., "gpt-4o-mini" or "gpt-3.5-turbo").                                                                                                                                                                                                                                                                               |
